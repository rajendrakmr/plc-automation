...
function validate(form: CategoryForm): FormErrors {
  ...
  if (!form.blog_tag_slug.trim()) e.blog_tag_slug = "Category slug is required.";
    ...
    <div className="ap-wrap">
      ...
      <div className="ap-header">
        <div className="ap-header-left">
          <p className="ap-title">Add New Tag</p>
          <p className="ap-sub">Fill all mandatory fields.</p>
        </div>
        <div className="ap-header-right">
          <Link href="/admin/blogs/tag" className="ap-back">
            ← Cancel
          </Link>
          <button
            className="ap-save"
      ...
      {success && (
        <div className="ap-banner success">✓ Tag saved successfully!</div>
      )}
        ...
        <Card>
          ...
          <div className="ap-f" ref={refs.blog_tag_name}>
            <label className="ap-lbl">
              Tag Name <span className="ap-req">*</span>
            </label>
            <FormInput
