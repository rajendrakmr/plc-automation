...
export default function AddProduct() {
  ...
  const { loading, error, success, post, reset } = usePost<ProductPayload, { id: string }>({
    url: "/products",
  ...
  // // 2. handleSubmit replace karo
  // const handleSubmit = async (status: "published" | "draft") => {
  //   reset();
  //   const errs = validate(form);
  //   if (Object.keys(errs).length) {
  //     setErrors(errs);
  //     document.querySelector(".ap-err")?.scrollIntoView({ behavior: "smooth", block: "center" });
  //     return;
  //   }
      ...
      <div className="ap-wrap">
        <div className="ap-header">
          <div className="ap-header-left">
            ...
            <div>
              <p className="ap-title">Add New Product</p>
              <p className="ap-sub" style={{fontWeight:"bold"}}>All (<span className="ap-req">*</span>) Indicates required fields.</p>
            </div>
          ...
          <div>
            ...
            <Card title="SEO & meta">
              ...
              <div className="ap-f" style={{ marginBottom: 0 }}>
                ...
                />
                {/* <p className={`ap-char-count${form.meta_description.length > 160 ? " over" : ""}`}>
              ...
              <div className="ap-status-cards">
                ...
                >
                  ...
                  <div className="ap-status-content">
                    ...
                    {/* <div className="ap-status-desc">
          Save product without publishing.
        </div> */}
                  </div>
                </label>
              </div>
