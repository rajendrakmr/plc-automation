      ...
      <div className="ap-wrap">
        <div className="ap-header">
          <div className="ap-header-left">
            ...
            <div>
              <p className="ap-title"><span style={{fontWeight:"bold",color:"#220429"}} >{form?.part_no}</span></p>
        ...
        {success && <div className="ap-banner success">✓ Product updated successfully!</div>}
