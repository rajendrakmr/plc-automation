  ...
  const contactInfo = [
    {
      ...
      content: (
        <>
          ...
          <br></br>PLC Automation Australia Pty Ltd Suite 302, 13/15 Wentworth Ave Sydney NSW 2000
        </>
      ),
    },
    // https://plcautomationgroup.com/tel:+65 6980 8259 ,SG: +65 8950 7034 , AU: +61 421 000 214
    {
      icon: "/assets/Icons/phone-plcautomationgroup.png",
      alt: "Phone Icon",
      title: "SPEAK TO US",
      content: "Mainline: SG: +65 8950 7034 , AU: +61 421 000 214",
      href: "tel:+65 8950 7034 , AU: +61 421 000 214",
    },
    {
      ...
      <section className="section_grey_content">
        <div className="section_container section-inner" style={{ paddingTop: "0px" }}>
          <div className="section-header">
            <h2 className="section-title">Our Head Offices</h2>
              ...
              <div className="address-card address-card--main" key={office.country}>
                ...
                <div className="address-contact">
                  <span style={{
                    ...
                    <Link href={office.phoneHref} className="contact-link">
                      {office.phone}
                    </Link>
                  </span>
                  <span
                  ...
                  >
                    ...
                    <Link href={office.emailHref} className="contact-link">
                      {office.email}
                    </Link>
                  </span>
