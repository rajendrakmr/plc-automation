...
export default function TeamSliderSection() {
    ...
    return (
     <div className="section_white_content">
           <section className="section_container section-team-slider">
